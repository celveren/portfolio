...
VPS_PATH=${VPS_PATH:-/var/www/celveren}
...
for file in index.html why-celveren.html tools-services.html 404.html styles.css script.js daily-artwork.js previews/index.html migration/index.html; do
